...
<h5 class="mt-3 mb-3"> Input Persediaan Barang Habis Pakai</h5>
  <form action="{{ url('DaftarBarang/simpan_barang')}}" method="post">
    {{ csrf_field() }}
    <div class="form-group mb-2">
      <label for="text" class="col-sm-2 col-form-label">Nama Barang</label>
      <input type="text" id="nama_barang" name="nama" class="form-control" placeholder="Nama Barang">
    </div>
