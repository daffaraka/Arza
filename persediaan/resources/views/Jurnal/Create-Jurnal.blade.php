...
@section('container')
    ...
    <form action="{{ url('Jurnal/simpan_jurnal') }}" method="post">
        ...
        <div class="form-group mb-2">
          ...
          <input type="number" id="debit" name="debit" class="form-control" placeholder="Debit">
      </div>
        <div class="form-group mb-2">
            <label for="text" class="col-sm-2 col-form-label">Keterangan Debit</label>
            <input type="text" id="uraian_debit" name="uraian_debit" class="form-control" placeholder="Uraian Debit">
        </div>
        <div class="form-group mb-2">
          <label for="text" class="col-sm-2 col-form-label">Kredit</label>
          <input type="number" id="kredit" name="kredit" class="form-control" placeholder="Kredit">
      </div>
        <div class="form-group mb-2">
            <label for="text" class="col-sm-2 col-form-label">Keterangan Kredit</label>
            <input type="text" id="uraian_kredit" name="uraian_kredit" class="form-control" placeholder="Uraian Kredit">
        </div>
        {{-- <div class="form-group mb-2">
        <label for="text" class="col-sm-2 col-form-label">Kredit</label>
