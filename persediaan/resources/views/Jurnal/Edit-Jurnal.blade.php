...
<h5 class="mt-3 mb-3"> Input Jurnal</h5>
  <form action="{{ url('Jurnal/simpan_jurnal')}}" method="post">
    ...
    <div class="form-group mb-2">
      ...
      <input type="number" id="debit" name="debit" class="form-control" placeholder="Uraian" value="{{$jurnal->uraian_debit}}">
    </div>
    <div class="form-group mb-2">
        <label for="text" class="col-sm-2 col-form-label">Keterangan Debit</label>
        <input type="text" id="uraian_debit" name="uraian_debit" class="form-control" placeholder="Uraian" value="{{$jurnal->uraian_debit}}">
    </div>
    <div class="form-group mb-2">
      <label for="text" class="col-sm-2 col-form-label">Kredit</label>
      <input type="number" id="kredit" name="kredit" class="form-control" placeholder="Debit" value="{{$jurnal->uraian_debit}}">
    </div>
    <div class="form-group mb-2">
      <label for="text" class="col-sm-2 col-form-label">Keterangan Kredit</label>
      <input type="text" id="uraian_kredit" name="uraian_kredit" class="form-control" placeholder="Uraian" value="{{$jurnal->uraian_debit}}">
    </div>
