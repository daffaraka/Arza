...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Pemasukkan Kartu Stok</h1>
</div>

<h5 class="mt-3 mb-3"> Input Pemasukkan Kartu Stok</h5>
  <form action="{{ url('Pemasukkan-KartuStok/KartuStok/Store-Pemasukkan',$kartustok->id)}}" method="post">
    {{ csrf_field() }}
   ...
   <div class="form-group mb-2">
    ...
    <div class="form-group mb-2">
        ...
        <input type="text" id="harga_per_unit_pengeluaran" name="harga_per_unit_pemasukan" class="form-control" placeholder="Harga Pemasukkan">
    </div>
    <div class="form-group mb-2">
        <label for="text" class="col-sm-2 col-form-label">Total Harga</label>
        <input type="text" id="total_harga_pengeluaran" name="total_harga_pemasukan" class="form-control" placeholder="Total Harga" readonly>
    </div>
