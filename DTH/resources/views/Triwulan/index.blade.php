...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    <div class="btn-group me-2">
      <a href="/DTH/Cetak-Triwulan" target="_blank" class="btn btn-sm btn-outline-secondary">PDF<span data-feather="printer"></span></a>
    </div>
  </div>
</div>
  ...
  <div class="card card-info card-outline">
    <div class="card-header">
      <div class="card-tools">
        <a href="/Triwulan/Create-Triwulan" class="btn btn-success">Tambah Data<i class="fas fa-plus-square"></i></a>
